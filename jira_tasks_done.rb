...
#getTasksDoneForActiveSprint(jira_board_id, jira_username, jira_password, jira_url)

SCHEDULER.every '5m', :first_in => 0 do |job|
	count = getTasksDoneForActiveSprint(jira_board_id, jira_username, jira_password, jira_url)
 
	send_event('jira_tasks_done', current: count)
end